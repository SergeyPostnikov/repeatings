...
# tuple 
eyes_color: tuple = (0, 0, 255)

# dict
person: dict = {'age': 13, 'name': 'Max', 'skills': skills}
...
пользователя, выводя слово Hello + имя. """  # done

"""Напишите программу, которая ожидает от пользователя три числа 
и выводит их сумму. Каждое число ожидается на новой строке."""  # done

"""Напишите программу считающую площадь прямоугольника. Длины сторон
программа ожидает от пользователя."""  # done
...
Требуется реализовать только функцию, решение не должно осуществлять операций ввода-вывода."""  # done
...
(!) Запрещено использовать встроенные возможности языка для сортировки.""" # done
